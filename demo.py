...
with st.expander("Customize the prompt"):
    ...
    prompt = st.text_area(
        "Prompt",
        "You are the manager of a corporate or school cafeterias, "
        "you receive customer comments, feedbacks frequently."
        "Please use humane, friendly, polite and formal writing to "
